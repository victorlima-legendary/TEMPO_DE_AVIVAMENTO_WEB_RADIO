...
async function getUploadedImages() {
    ...
    const accessToken = '410593abc9921c10592cb460d517922669bf6c38'; // Seu access token aqui
    ...
    try {
        ...
        if (data.success) {
            ...
            images.forEach(image => {
                ...
                <a href="https://www.google.com" target="__blank"><img src="https://i.imgur.com/${image.id}.${image.type.split('/')[1]}" alt="${image.title}" /></a>
